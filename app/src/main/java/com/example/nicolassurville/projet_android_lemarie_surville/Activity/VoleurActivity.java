...
public class VoleurActivity extends AppCompatActivity {


    private RecyclerView rv;
    public static final String HEARTHSTONE_UPDATE = "https://raw.githubusercontent.com/Deckmir/Projet_Android_Lemarie_Surville/master/cardsVoleur.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_voleur);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Card_Services.startActionCards(VoleurActivity.this);

            }
        });

        rv = (RecyclerView) findViewById(R.id.rv_voleur);
        lancement_JSON();
    }
    private void lancement_JSON(){
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        if(jsonObject.getString("playerClass").equals("Rogue")) {
        ...
        requestQueue = Volley.newRequestQueue(VoleurActivity.this);
    ...
    private void quit(){
        ...
        alertDialogBuilder.setNegativeButton(R.string.message_yes,new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(VoleurActivity.this,R.string.message_quit,Toast.LENGTH_LONG).show();
                finish();
            }
        });
