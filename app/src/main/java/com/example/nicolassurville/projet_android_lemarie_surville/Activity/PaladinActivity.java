...
public class PaladinActivity extends AppCompatActivity {
    ...
    public static final String HEARTHSTONE_UPDATE = "https://raw.githubusercontent.com/Deckmir/Projet_Android_Lemarie_Surville/master/cardsPaladin.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Card_Services.startActionCards(PaladinActivity.this);

            }
        });

        rv = (RecyclerView) findViewById(R.id.rv_paladin);
        lancement_JSON();
    }
    private void lancement_JSON(){
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        if(jsonObject.getString("playerClass").equals("Paladin")) {
        ...
        requestQueue = Volley.newRequestQueue(PaladinActivity.this);
    ...
    private void quit(){
        ...
        alertDialogBuilder.setNegativeButton(R.string.message_yes,new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(PaladinActivity.this,R.string.message_quit,Toast.LENGTH_LONG).show();
                finish();
            }
        });
