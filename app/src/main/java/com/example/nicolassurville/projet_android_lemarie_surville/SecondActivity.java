    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                LocalBroadcastManager.getInstance(SecondActivity.this).registerReceiver(new CardUpdate(), intentFilter);
                Card_Services.startActionCards(SecondActivity.this);

            }
        });

        rv = (RecyclerView) findViewById(R.id.rv_card);
